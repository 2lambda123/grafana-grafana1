...
require (
	...
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.35.2-20241125112653-c8424729fd5d.1 // @grafana/observability-traces-and-profiling
	...
	github.com/ProtonMail/go-crypto v1.1.4 // @grafana/plugins-platform-backend
	...
	github.com/go-ldap/ldap/v3 v3.4.9 // @grafana/identity-access-team
	...
	github.com/golang-migrate/migrate/v4 v4.18.1 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana-aws-sdk v0.31.6 // @grafana/aws-datasources
	github.com/grafana/grafana-azure-sdk-go/v2 v2.1.3 // @grafana/partner-datasources
	github.com/grafana/grafana-cloud-migration-snapshot v1.7.0 // @grafana/grafana-operator-experience-squad
	...
	github.com/linkedin/goavro/v2 v2.13.0 // @grafana/grafana-backend-group
	github.com/m3db/prometheus_remote_client_golang v0.4.4 // @grafana/grafana-backend-group
	github.com/madflojo/testcerts v1.3.0 // @grafana/alerting-backend
	...
	github.com/mattn/go-sqlite3 v1.14.24 // @grafana/grafana-backend-group
	...
	github.com/openfga/api/proto v0.0.0-20241230191130-b61b4ea28b71 // @grafana/identity-access-team
	github.com/openfga/language/pkg/go v0.2.0-beta.2.0.20241115164311-10e575c8e47c // @grafana/identity-access-team
	github.com/openfga/openfga v1.8.3 // @grafana/identity-access-team
	...
	google.golang.org/api v0.218.0 // @grafana/grafana-backend-group
	google.golang.org/grpc v1.69.4 // @grafana/plugins-platform-backend
	google.golang.org/protobuf v1.36.3 // @grafana/plugins-platform-backend
