...
require (
	...
	github.com/ProtonMail/go-crypto v1.1.2 // @grafana/plugins-platform-backend
	...
	github.com/openfga/api/proto v0.0.0-20241107182745-c14fb4b3d4b4 // @grafana/identity-access-team
	github.com/openfga/language/pkg/go v0.2.0-beta.2.0.20240926131254-992b301a003f // @grafana/identity-access-team
	github.com/openfga/openfga v1.8.0 // @grafana/identity-access-team
	...
	github.com/spyzhov/ajson v0.9.4 // @grafana/grafana-app-platform-squad
	...
	google.golang.org/api v0.203.0 // @grafana/grafana-backend-group
	...
	k8s.io/api v0.31.2 // @grafana/grafana-app-platform-squad
	...
	k8s.io/client-go v0.31.2 // @grafana/grafana-app-platform-squad
...
require (
	...
	google.golang.org/genproto v0.0.0-20241015192408-796eee8c2d53 // indirect; @grafana/grafana-backend-group
