...
require (
	...
	cloud.google.com/go/kms v1.18.4 // @grafana/grafana-backend-group
	...
	github.com/grafana/pyroscope/api v0.4.0 // @grafana/observability-traces-and-profiling
	...
	github.com/prometheus/common v0.59.1 // @grafana/alerting-backend
	...
	google.golang.org/grpc v1.66.1 // @grafana/plugins-platform-backend
...
require (
	...
	google.golang.org/genproto v0.0.0-20240730163845-b1a4ccb954bf // indirect; @grafana/grafana-backend-group
